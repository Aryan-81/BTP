...
from lib.utils.FaceDetector import FAN
from lib.datasets.FaceVideoDataModule import TestFaceVideoDM
import lib
...
from lib.utils.lightning_logging import _fix_image
...
def save_obj(emoca, filename, opdict, i=0):
    ...
    dense_template_path = Path(lib.__file__).parents[1] / 'assets' / "DECA" / "data" / 'texture_data_256.npy'
