...
from lib.datasets.IO import load_segmentation, process_segmentation, load_emotion, save_emotion
from lib.utils.image import numpy_image_to_torch
from lib.transforms.keypoints import KeypointNormalization
import imgaug
from lib.datasets.FaceDataModuleBase import FaceDataModuleBase
from lib.datasets.ImageDatasetHelpers import bbox2point, bbpoint_warp
from lib.datasets.EmotionalImageDataset import EmotionalImageDatasetBase
from lib.datasets.UnsupervisedImageDataset import UnsupervisedImageDataset
from lib.utils.FaceDetector import save_landmark, load_landmark
from tqdm import auto
import traceback
from torch.utils.data.dataloader import DataLoader
from lib.transforms.imgaug import create_image_augmenter
from torchvision.transforms import Resize, Compose
from sklearn.neighbors import NearestNeighbors
from torch.utils.data._utils.collate import default_collate
from torch.utils.data.sampler import WeightedRandomSampler
from lib.utils.other import class_from_str
...
class AffectNetDataModule(FaceDataModuleBase):
    ...
    def _detect_landmarks_mediapipe(self, start_i, end_i):
        ...
        completed = status_array[start_i // self.subset_size]
        del status_array
        from lib.utils.FaceDetector import save_landmark_v2, save_landmark
        from lib.utils.MediaPipeLandmarkDetector import MediaPipeLandmarkDetector
